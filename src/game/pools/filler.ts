...
e({
    ...
    choices: [
      { id: "menangis", label: "Menangis sekencang-kencangnya", outcomes: [
        ...
        { weight: 8, text: "Kamu menangis sampai tetangga ikut keluar menengok. Lukanya kecil, tapi perhatian yang kamu dapat dari ibu hari itu terasa seluas dunia.", effects: { happiness: 3, mental: 2 } },
      ...
      { id: "naik_lagi", label: "Bangun, naik sepeda lagi", outcomes: [
        ...
        { weight: 8, text: "Kamu naik lagi, dan kali ini bisa sampai ujung gang tanpa jatuh. Tidak ada yang melihat kemenangan kecil itu kecuali kamu. Sebagian besar kemenangan dalam hidup memang begitu.", effects: { discipline: 3, happiness: 2 } },
      ]},
    ],
  }),
...
e({
    ...
    choices: [
      { id: "simpan", label: "Lipat, simpan di dompet kecil", outcomes: [
        ...
        { weight: 8, text: "Kamu lipat empat kali, simpan di saku terdalam, dan diam-diam membacanya lagi saat pelajaran membosankan. Dua kata yang entah kenapa cukup untuk menyelesaikan satu hari kecil.", effects: { happiness: 5, mental: 4 }, mood: "warm",
...
e({
    ...
    choices: [
      { id: "ikut", label: "Ikut, lepas sepatu", outcomes: [
        ...
        { weight: 8, text: "Kamu ikut, dan guru memarahi kalian semua di depan kelas dengan baju basah. Tapi barisan itu menahan tawa diam-diam, dan kamu merasa jadi bagian dari sesuatu. Hukuman paling sepadan yang pernah kamu terima.", effects: { happiness: 6, social: 3, health: -2 }, memory: { text: "Dimarahi sekelas dengan baju basah, menahan tawa di barisan.", tag: "sd_basah", mood: "warm" } },
      ]},
...
e({
    ...
    choices: [
      { id: "pinjam_terus", label: "Pinjam berulang sampai dimarahi penjaga perpus", outcomes: [
        ...
        { weight: 8, text: "Kamu pinjam berulang sampai hafal nomor panggilnya. Suatu hari buku itu hilang dari rak. Kamu mencarinya bertahun-tahun, tidak pernah ingat judulnya, hanya rasanya.", effects: { intelligence: 4, happiness: 2 }, addTrait: "curious", mood: "melancholy", memory: { text: "Buku yang seperti ditulis untukmu, hilang sebelum kamu hafal judulnya.", tag: "buku_terbaik", mood: "melancholy" } },
      ]},
...
e({
    ...
    choices: [
      { id: "ikut", label: "Ikut, walau uangmu tipis", outcomes: [
        ...
        { weight: 8, text: "Satu porsi mie ayam dibagi bertiga, kuah diminta tambah gratis sampai penjualnya pura-pura tidak lihat. Bumbunya biasa saja, tapi tawa kalian membuatnya jadi yang terenak yang kamu ingat sampai tua.", effects: { social: 5, happiness: 6 }, memory: { text: "Satu mangkok mie ayam dibagi bertiga di warung pinggir jalan.", tag: "warung_remaja", mood: "warm" } },
        { weight: 8, text: "Hujan turun begitu kalian duduk, jadi alasan untuk berlama-lama. Es teh, gorengan, dan obrolan yang tidak penting tapi tidak ingin kalian sudahi. Warung itu menahan kalian sampai langit gelap.", effects: { social: 5, happiness: 5 }, memory: { text: "Terjebak hujan di warung, obrolan remaja yang tak ingin disudahi.", tag: "warung_remaja", mood: "warm" } },
      ]},
      ...
      { id: "bayari", label: "Bayari semua dari uang tabungan", outcomes: [
        ...
        { weight: 8, text: "Kamu keluarkan uang tabungan diam-diam, biar tak ada yang merasa berutang. Tidak ada yang tahu itu sisa uang jajanmu minggu itu. Kamu pulang jalan kaki, dan anehnya merasa kaya.", effects: { wealth: -3, social: 3, happiness: 2 } },
      ]},
    ],
  }),
...
e({
    ...
    choices: [
      { id: "menangis", label: "Menangis pelan sambil rebahan", outcomes: [
        ...
        { weight: 8, text: "Kamu menelepon rumah, tapi begitu telepon diangkat kamu malah tidak bisa bicara. 'Halo? Halo?' terdengar di seberang, sampai kamu menutup dengan alasan sinyal. Kadang kita paling rindu pada suara yang justru tidak sanggup kita dengar.", effects: { mental: -2, social: 1 }, flag: "tinggal_kos", mood: "melancholy", memory: { text: "Telepon rumah malam pertama di kos, yang tak sanggup kamu lanjutkan.", tag: "kos_pertama", mood: "melancholy" } },
      ]},
      { id: "beresin", label: "Beresin koper dulu, baru istirahat", outcomes: [
        ...
        { weight: 8, text: "Kamu tata semuanya rapi sampai kamar asing itu mulai terasa seperti milikmu. Menjelang tidur kamu merasa sedikit bangga. Ini kamarmu, hasil keputusanmu sendiri, sesempit apa pun.", effects: { discipline: 3, mental: 2, happiness: 1 }, flag: "tinggal_kos" },
      ]},
...
e({
    ...
    choices: [
      ...
      { id: "ganti", label: "Ganti pembimbing", outcomes: [
        ...
        { weight: 8, text: "Pembimbing baru membaca skripsimu semalam, mengembalikannya penuh coretan. Sakit, tapi akhirnya ada yang benar-benar membaca tulisanmu. Kamu lulus terlambat, tapi lebih merasa berhak lulus.", effects: { intelligence: 4, discipline: 3, mental: 1 }, flag: "sudah_lulus" },
      ]},
      { id: "menyerah", label: "Cuti dulu, jeda", outcomes: [
        ...
        { weight: 8, text: "Cuti itu kamu isi dengan kerja serabutan dan tidur yang cukup untuk pertama kalinya dalam setahun. Saat kembali, skripsi yang dulu seperti tembok ternyata cuma tumpukan tugas biasa. Yang berubah bukan skripsinya, tapi kamu.", effects: { mental: 5, discipline: 2, wealth: -2 } },
      ]},
    ],
  }),
...
e({
    ...
    choices: [
      ...
      { id: "tolak_tegas", label: "Bilang jujur kamu tidak siap", outcomes: [
        ...
        { weight: 8, text: "Kejujuran itu membuat satu-dua orang ikut mengaku mereka juga datang ke reuni cuma karena takut dianggap sombong. Mungkin separuh reuni memang dihadiri orang yang sama-sama tidak ingin datang.", effects: { social: 2, mental: 3 } },
      ]},
    ],
  }),
...
e({
    ...
    choices: [
      ...
      { id: "scan", label: "Foto, simpan di cloud", outcomes: [
        ...
        { weight: 8, text: "Kamu foto resepnya dari berbagai sudut, takut kehilangan satu coretan pun. Lalu kamu sadar yang kamu takut hilang bukan resepnya, tapi tulisan tangannya, satu-satunya yang tersisa yang masih berbentuk dia.", effects: { mental: 4, discipline: 2 }, mood: "melancholy" },
      ]},
...
e({
    ...
    choices: [
      ...
      { id: "tunda", label: "Tunda. Ponselmu masih bisa dijauhkan.", outcomes: [
        ...
        { weight: 8, text: "Kamu tunda, lalu mendapati diri membaca menu restoran dengan tangan yang terjulur maksimal seperti sedang menjauhkan dunia. Pelayan muda menahan senyum. Kamu pesan kacamata minggu itu juga, kalah oleh menu nasi goreng.", effects: { health: -1, happiness: 1 } },
      ]},
    ],
  }),
...
e({
    ...
    choices: [
      { id: "serius", label: "Ubah pola makan, mulai jalan kaki", outcomes: [
        ...
        { weight: 8, text: "Kamu mulai jalan kaki tiap pagi, dan diam-diam menikmati sunyi subuh yang tidak pernah kamu kenal sebelumnya. Angkanya membaik. Tapi yang lebih berharga adalah kamu menemukan satu jam dalam sehari yang benar-benar milikmu.", effects: { health: 7, discipline: 4, mental: 3 } },
      ]},
      { id: "abaikan", label: "Simpan map, lupakan", outcomes: [
        ...
        { weight: 8, text: "Kamu taruh map itu di laci yang sama tempat semua hal yang ingin kamu lupakan. Tubuhmu masih terasa baik-baik saja, dan 'baik-baik saja' adalah pembohong yang paling kamu percaya.", effects: { health: -8, mental: 1 }, flag: "abai_kesehatan", mood: "melancholy" },
      ]},
      { id: "panik", label: "Panik, googling sampai pagi", outcomes: [
        ...
        { weight: 8, text: "Kamu googling sampai pagi, tidur dengan keyakinan kamu tidak akan bangun. Kamu bangun, tentu saja. Lalu kamu bikin janji dokter beneran. Kepanikan, sesekali, adalah pintu masuk ke tindakan yang benar.", effects: { mental: -3, health: 2 } },
      ]},
    ],
  }),
...
e({
    ...
    choices: [
      { id: "amati", label: "Tersenyum, amati", outcomes: [
        ...
        { weight: 8, text: "Seorang anak jatuh tak jauh darimu, menangis, lalu bangun sendiri sebelum kamu sempat beranjak. Kamu cukup jadi saksi sekarang, dan itu peran yang terhormat.", effects: { mental: 5, happiness: 3 }, mood: "warm" },
      ]},
