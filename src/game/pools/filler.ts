...
<<<<<<< HEAD
        { weight: 8, text: "Kamu menangis sampai tetangga menengok. Lukanya kecil, tapi perhatian ibu hari itu seluas dunia.", effects: { happiness: 3, mental: 2 } },
        { weight: 8, text: "Air matamu lebih banyak dari darahnya. Ibu menempelkan plester bergambar, dan entah kenapa sakitnya berkurang separuh.", effects: { happiness: 3, mental: 2 } },
=======
...
>>>>>>> 75a53157427c90e3cdc28a4b3b8995d6d477b194
      ]},
...
<<<<<<< HEAD
        { weight: 8, text: "Dimarahi sebaris dengan baju basah. Tapi kalian menahan tawa diam-diam. Hukuman paling sepadan yang pernah kamu terima.", effects: { happiness: 6, social: 3, health: -2 }, memory: { text: "Dimarahi sekelas dengan baju basah, menahan tawa di barisan.", tag: "sd_basah", mood: "warm" } },
=======
...
<<<<<<< HEAD
        { weight: 5, text: "Suatu hari buku itu hilang dari rak. Kamu mencarinya bertahun-tahun, tidak pernah ingat judulnya.", effects: { intelligence: 4, happiness: 2 }, addTrait: "curious", mood: "melancholy", memory: { text: "Buku yang seperti ditulis untukmu, hilang sebelum kamu hafal judulnya.", tag: "buku_terbaik", mood: "melancholy" } },
=======
...
<<<<<<< HEAD
        { weight: 8, text: "Uangmu cuma cukup untuk teh, tapi mereka berbagi gorengan tanpa diminta. Kamu pulang kenyang oleh hal yang bukan makanan.", effects: { social: 5, happiness: 5 }, memory: { text: "Gorengan yang dibagi tanpa diminta, sore di warung pinggir jalan.", tag: "warung_remaja", mood: "warm" } },
        { weight: 8, text: "Satu mie ayam dibagi bertiga, kuah tambah gratis sampai penjualnya pura-pura tak lihat. Bumbunya biasa, tapi terenak yang kamu ingat sampai tua.", effects: { social: 5, happiness: 6 }, memory: { text: "Satu mangkok mie ayam dibagi bertiga di warung pinggir jalan.", tag: "warung_remaja", mood: "warm" } },
        { weight: 8, text: "Hujan turun, jadi alasan berlama-lama. Es teh, gorengan, obrolan tak penting yang tak ingin disudahi. Warung itu menahan kalian sampai gelap.", effects: { social: 5, happiness: 5 }, memory: { text: "Terjebak hujan di warung, obrolan remaja yang tak ingin disudahi.", tag: "warung_remaja", mood: "warm" } },
=======
...
>>>>>>> 75a53157427c90e3cdc28a4b3b8995d6d477b194
      ...
      { id: "tolak", label: "Tolak, langsung pulang", outcomes: [
        ...
        { weight: 8, text: "Kamu bilang ada urusan, padahal cuma ingin pulang. Di rumah, grup mereka berbunyi terus, penuh tawa yang tak kamu ikuti. Kamu matikan suaranya, lalu menyesal.", effects: { social: -3, mental: -2 }, mood: "melancholy" },
      ]},
...
<<<<<<< HEAD
        { weight: 5, text: "Tidak ada yang tahu itu sisa uang jajanmu minggu itu. Kamu pulang jalan kaki, dan anehnya merasa kaya.", effects: { wealth: -3, social: 3, happiness: 2 } },
=======
...
<<<<<<< HEAD
        { weight: 8, text: "Foto keluarga kecil dari tas. Kamu tidak tahu mau ditaruh di mana, akhirnya di laci. Beberapa hal butuh waktu menemukan tempatnya.", effects: { discipline: 2, mental: 1 }, flag: "tinggal_kos" },
=======
...
<<<<<<< HEAD
        { weight: 5, text: "Yang membuka pintu sama canggungnya. Obrolan kaku lima menit, lalu pamit. Tapi satu wajah dikenal di tempat asing sudah cukup.", effects: { social: 3, mental: 2 }, flag: "tinggal_kos", addsRelationship: { name: "Tetangga Kos", role: "friend", closeness: 25, alive: true } },
=======
...
<<<<<<< HEAD
        { weight: 5, text: "Dia kembalikan skripsimu penuh coretan dalam semalam. Sakit, tapi akhirnya ada yang benar-benar membacanya. Kamu lulus terlambat, tapi merasa berhak.", effects: { intelligence: 4, discipline: 3, mental: 1 }, flag: "sudah_lulus" },
      ]},
      { id: "menyerah", label: "Cuti dulu, jeda", outcomes: [
        ...
        { weight: 5, text: "Kamu kembali setelah tidur cukup untuk pertama kali dalam setahun. Skripsi yang dulu seperti tembok ternyata cuma tumpukan tugas. Yang berubah bukan skripsinya, tapi kamu.", effects: { mental: 5, discipline: 2, wealth: -2 } },
=======
  ...
  e({
    ...
    choices: [
      { id: "datang", label: "Datang, beri ucapan tulus", outcomes: [
        ...
        { weight: 8, text: "Di antara ratusan tamu, dia mencarimu hanya untuk bilang 'makasih udah dateng,' lalu ditarik keramaian. Pertemanan dewasa: pertemuan singkat di sela hidup yang sudah penuh.", effects: { social: 4, happiness: 4 }, mood: "warm" },
      ]},
...
<<<<<<< HEAD
        { weight: 5, text: "Satu-dua orang ikut mengaku mereka datang cuma karena takut dianggap sombong. Mungkin separuh reuni dihadiri orang yang sama-sama tak ingin datang.", effects: { social: 2, mental: 3 } },
=======
...
<<<<<<< HEAD
        { weight: 5, text: "Kamu foto dari berbagai sudut, takut kehilangan satu coretan pun. Lalu sadar yang kamu takut hilang bukan resepnya, tapi tulisan tangannya.", effects: { mental: 4, discipline: 2 }, mood: "melancholy" },
=======
...
>>>>>>> 75a53157427c90e3cdc28a4b3b8995d6d477b194
      ...
      { id: "bingkai", label: "Bingkai, gantung di dapur", outcomes: [
        ...
        { weight: 8, text: "Tamu mengira itu hiasan. Bagimu itu kehadiran. Setiap masakan jadi percakapan dengan seseorang yang sudah tidak menjawab.", effects: { mental: 5, happiness: 3 }, mood: "warm" },
      ]},
    ],
  }),
...
<<<<<<< HEAD
        { weight: 5, text: "Kamu baca menu dengan tangan terjulur maksimal, seperti menjauhkan dunia. Pelayan muda menahan senyum. Kamu pesan kacamata minggu itu juga.", effects: { health: -1, happiness: 1 } },
=======
...
<<<<<<< HEAD
        { weight: 5, text: "Map itu masuk laci yang sama dengan semua hal yang ingin kamu lupakan. Tubuhmu masih baik-baik saja, dan 'baik-baik saja' pembohong yang paling kamu percaya.", effects: { health: -8, mental: 1 }, flag: "abai_kesehatan", mood: "melancholy" },
      ]},
      { id: "panik", label: "Panik, googling sampai pagi", outcomes: [
        ...
        { weight: 5, text: "Kamu tidur dengan keyakinan tidak akan bangun. Kamu bangun, tentu saja, lalu bikin janji dokter beneran. Panik, sesekali, jadi pintu ke tindakan yang benar.", effects: { mental: -3, health: 2 } },
=======
...
<<<<<<< HEAD
        { weight: 5, text: "Suatu pagi ada nama yang kamu kenal. Teman lama, hilang kontak puluhan tahun. Kalian terpisah lebih lama dari masa kalian pernah berteman. Kamu lipat koran itu pelan.", effects: { mental: -4, happiness: -1 }, mood: "melancholy", memory: { text: "Nama teman lama yang kamu temukan di halaman obituari.", tag: "kehilangan", mood: "melancholy" } },
=======
...
<<<<<<< HEAD
        { weight: 5, text: "Yang ingin kamu sebut bukan jabatan, tapi sore-sore biasa, orang yang kamu temani, hal yang tak pernah masuk koran. Kamu tutup buku itu, anehnya, lega.", effects: { mental: 6, happiness: 2 }, mood: "melancholy", memory: { text: "Obituari yang kamu tulis, berisi sore-sore biasa, bukan pencapaian.", tag: "tua", mood: "melancholy" } },
=======
...
<<<<<<< HEAD
        { weight: 5, text: "Seorang anak jatuh, menangis, lalu bangun sendiri sebelum kamu sempat beranjak. Kamu cukup jadi saksi sekarang. Peran yang terhormat.", effects: { mental: 5, happiness: 3 }, mood: "warm" },
      ]},
      { id: "ajak", label: "Ajak ngobrol kakek di sebelahmu", outcomes: [
        ...
        { weight: 5, text: "Dia menunjuk pohon besar di ujung taman. 'Saya yang tanam, empat puluh tahun lalu.' Kalian menatapnya dalam diam. Ada warisan yang tidak butuh nama.", effects: { social: 3, mental: 5 }, mood: "melancholy", memory: { text: "Kakek taman dan pohon yang ia tanam empat puluh tahun lalu.", tag: "tua", mood: "melancholy" } },
=======
