...
export const CALLBACK_POOL: LifeEvent[] = [
  e({
    ...
    prompt: "Suatu sore kamu sadar sudah lama tidak menyiapkan kursi untuknya. Tidak ada perpisahan, tidak ada pertengkaran. Dia hanya pelan-pelan menjadi sesuatu, yang kamu sadar, tidak pernah benar-benar ada.",
    choices: [
      { id: "pamit", label: "Ucapkan selamat tinggal pelan-pelan", outcomes: [
        ...
        { weight: 8, text: "Kamu siapkan kursinya terakhir kali, isi dengan biskuit, lalu bilang bahwa kamu akan baik-baik saja sekarang. Konyol, dan kamu tahu itu. Tapi bertahun kemudian kamu sadar, itu cara kamu belajar melepaskan dengan lembut.", effects: { mental: 3, intelligence: 1 }, mood: "melancholy", flag: "teman_khayalan_selesai", endsRelationship: "teman_khayalan",
      ...
      { id: "lupakan", label: "Tidak memikirkannya lagi", outcomes: [
        { weight: 6, text: "Begitu saja, dia hilang dari hari-harimu tanpa kamu sadari. Begitulah cara sebagian besar orang akan meninggalkan hidupmu nanti, bukan dengan pintu yang dibanting, tapi dengan kursi yang lama-lama berhenti disiapkan.", effects: { mental: -2 }, mood: "melancholy", flag: "teman_khayalan_selesai", endsRelationship: "teman_khayalan" },
  ...
  e({
    ...
    choices: [
      ...
      { id: "simpan", label: "Simpan di kotak, tutup lagi", outcomes: [
        ...
        { weight: 8, text: "Kamu tutup kotaknya, lalu membukanya sekali lagi untuk menatap cat yang sudah pudar itu. Lalu kamu tutup untuk terakhir kali. Beberapa hal kita jaga justru dengan tidak menyentuhnya.", effects: { mental: 2 }, mood: "melancholy" },
      ]},
    ],
  }),
  ...
  e({
    ...
    choices: [
      { id: "mampir", label: "Mampir, beli sesuatu", outcomes: [
        { weight: 8, text: "Bu Tini masih ada. Lebih kecil dan lebih lambat. Dia tidak ingat kamu, dan itu tidak apa-apa.", effects: { mental: 3, happiness: 4 }, memory: { text: "Bu Tini, masih di warungnya, tidak mengenalimu.", tag: "warung_lama", mood: "melancholy" } },
      ...
      { id: "lewat", label: "Lewatkan saja", outcomes: [
        ...
        { weight: 8, text: "Kamu lewatkan, lalu memutar balik dua kilometer kemudian. Tapi kamu cuma diam di seberang dan menatapnya dari jauh. Ada nostalgia yang lebih aman dibiarkan jadi pemandangan.", effects: { mental: -1 }, mood: "melancholy" },
      ]},
    ],
  }),
  ...
  e({
    ...
    prompt: (ctx) => {
      const v = [
        ...
        "Tanpa sengaja kamu mengetik sebuah nama di kolom pencarian. Chat-nya muncul, lengkap, beku di pesan terakhir yang tak pernah sempat kalian lanjutkan.",
      ];
    ...
    choices: [
      ...
      { id: "kirim", label: "Tetap kirim pesan", outcomes: [
        ...
        { weight: 8, text: "Kamu kirim, bukan kabar, cuma 'hai.' Centangnya satu, abu-abu, selamanya. Tapi ada lega yang aneh. Rasa rindu itu akhirnya keluar dari dadamu.", effects: { mental: 4 }, mood: "melancholy", memory: { text: "'Hai' yang kamu kirim ke centang yang tak akan pernah jadi dua.", tag: "kehilangan", mood: "melancholy" } },
      ]},
    ],
  }),
  ...
  e({
    ...
    choices: [
      { id: "buang", label: "Buang", outcomes: [
        ...
        { weight: 8, text: "Kamu membuangnya, lalu menyesal sebelum tempat sampah ditutup. Tapi gengsi menahanmu mengambilnya lagi.", effects: { mental: -3 }, mood: "melancholy" },
      ]},
  ...
  e({
    ...
    choices: [
      ...
      { id: "akui", label: "Akui, kamu menyimpannya terlalu lama", outcomes: [
        { weight: 5, text: "Dia memegang tempat untuk kesepian yang tidak pernah kamu beri nama. Melepasnya berarti mengakui kesepian itu, dan anehnya, justru pengakuan itu yang meringankanmu.", effects: { mental: 2, intelligence: 2 }, mood: "melancholy", flag: "teman_khayalan_selesai", endsRelationship: "teman_khayalan" },
        { weight: 8, text: "Lalu kamu sudah berhenti menyisakan tempat untuk seseorang yang tidak pernah ada.", effects: { mental: 2 }, mood: "melancholy", flag: "teman_khayalan_selesai", endsRelationship: "teman_khayalan" },
      ]},
    ],
  }),
    ...
    choices: (ctx) => ctx.state.flags.surat_isi_pesan
      ? [
        { id: "buka", label: "Buka, baca pelan-pelan", outcomes: [
          { weight: 8, text: "Cuma tiga kata, persis seperti yang samar kamu ingat, 'Semoga kamu senang.' Tidak ada cita-cita, tidak ada tuntutan. Anak sekecil itu sudah tahu mendoakan satu-satunya hal yang penting.", effects: { mental: 4, happiness: 3 }, mood: "melancholy",
        ...
        { id: "simpan", label: "Pegang, tapi belum sanggup membukanya", outcomes: [
          ...
          { weight: 8, text: "Begitu sedikit yang ditulis, begitu banyak yang diharapkannya. Kamu menyimpannya lagi. Mungkin besok kamu cukup berani untuk bertemu dengan anak yang dulu menulisnya.", effects: { mental: 2 }, mood: "melancholy" },
        ]},
      ]
      : [
        { id: "buka", label: "Buka, baca pelan-pelan", outcomes: [
          { weight: 8, text: "Daftar panjang itu memintamu hal-hal besar. Sebagian kamu tepati, sebagian tidak. Yang membuat matamu panas bukan cita-cita yang gagal, tapi betapa yakinnya kamu dulu bahwa semuanya akan pasti terjadi.", effects: { mental: 4, happiness: 3 }, mood: "melancholy",
            memory: { text: "Daftar cita-cita dari dirimu yang kecil, akhirnya kamu buka.", tag: "surat_kapsul", mood: "melancholy" } },
          { weight: 8, text: "Di antara cita-cita besar itu ada satu baris kecil, 'bisa main terus.' Kamu menimbang apakah kamu menepatinya, lalu tertawa kecil. Kamu mulai menepatinya hari ini juga, semoga belum terlambat untuk surat yang sabar menunggu puluhan tahun.", effects: { mental: 5, happiness: 4 }, mood: "warm",
        ...
        { id: "simpan", label: "Pegang, tapi belum sanggup membukanya", outcomes: [
          ...
          { weight: 8, text: "Mungkin besok. Atau mungkin saat kamu cukup berani bertemu anak yang dulu menulis daftar cita-cita itu.", effects: { mental: 2 }, mood: "melancholy" },
      ]},
    ],
  }),
];
