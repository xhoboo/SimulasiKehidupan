    ...
    choices: (ctx) => {
      const choices: Choice[] = [
        { id: "sistem", label: "Coba buat anggaran yang lebih ketat", outcomes: [
          ...
          { weight: 6, text: "Rajin seminggu, lalu lupa. Tapi kamu jadi tahu persis ke mana uangmu lari. Pengetahuan yang tidak menyenangkan.", effects: { intelligence: 3, discipline: 2 }, extraFlags: ["akhir_bulan_2"] },
        ]},
        ...
        { id: "terima", label: "Terima ini sebagai kondisi hidup sekarang", outcomes: [
          ...
          { weight: 6, text: "Kamu berhenti memarahi diri sendiri tiap akhir bulan. Bukan menyerah, hanya berhenti menambah luka di atas luka.", effects: { mental: 3, happiness: -2 }, extraFlags: ["akhir_bulan_2"] },
        ]},
      ];
  ...
  e({
    ...
    choices: [
      ...
      { id: "jual", label: "Jual barang di marketplace", outcomes: [
        ...
        { weight: 6, text: "Yang laku justru jam tangan pemberian ayahmu. Pembelinya menawar tega, kamu terima. Uangnya bertahan dua minggu, rasa kehilangannya jauh lebih panjang.", effects: { wealth: 7, happiness: -4, mental: -2 }, extraFlags: ["akhir_bulan_1"], mood: "melancholy" },
      ]},
    ],
  }),
  ...
  e({
    ...
    choices: [
      { id: "putus_siklus", label: "Putuskan, ubah sesuatu yang struktural", outcomes: [
        { weight: 8, text: "Kamu pilih satu, lalu jalani. Bukan ajaib, tapi arahnya benar untuk pertama kalinya.", effects: { mental: 6, wealth: 3, discipline: 5 } },
        { weight: 8, text: "Resolusinya kuat. Pelaksanaannya kurang. Tapi kali ini kamu sadar ada yang harus diubah.", effects: { mental: 3, discipline: 2 } },
      ]},
      { id: "filosofis", label: "Sadari, banyak orang hidup seperti ini seumur hidup", outcomes: [
        ...
        { weight: 8, text: "Orang-orang di angkot, di warung, di halte. Masing-masing memikul siklus yang sama, diam-diam. Anehnya itu menghibur.", effects: { mental: 3, social: 1, happiness: -1 } },
      ]},
      { id: "minta_tolong", label: "Ceritakan ke keluarga, minta bantuan sementara", outcomes: [
        ...
        { weight: 8, text: "Mereka membantu, ikhlas. Tapi ada tatapan yang sulit tidak dibaca. Kamu berterima kasih sambil menelan sesuatu.", effects: { wealth: 5, mental: -3 } },
      ]},
    ],
  }),
  ...
  e({
    ...
    choices: [
      { id: "rumah", label: "Beli rumah cash", outcomes: [
        ...
        { weight: 4, text: "Kamu isi dengan orang-orang. Keluarga, teman yang singgah. Ruang kosong cuma menakutkan kalau kamu sendirian.", effects: { wealth: 22, happiness: 8, social: 5 }, mood: "warm" },
      ]},
      { id: "bagi", label: "Bagikan ke keluarga", outcomes: [
        ...
        { weight: 6, text: "Sebagian berterima kasih seumur hidup. Sebagian merasa kurang, lalu menjauh. Uang tidak mengubah orang, hanya memperjelasnya.", effects: { wealth: 4, social: -2, mental: 3 }, mood: "melancholy" },
      ]},
      { id: "donasi", label: "Donasikan setengah", outcomes: [
        ...
        { weight: 8, text: "Tanpa plakat, tanpa foto. Bertahun kemudian kamu bertemu orang yang hidupnya berubah karenamu, dan dia tidak tahu. Kamu simpan itu seperti harta.", effects: { wealth: 9, mental: 9, happiness: 5 }, achievement: "Diam-diam Murah Hati", mood: "warm" },
      ]},
      { id: "investasi", label: "Investasi ulang", outcomes: [
        ...
        { weight: 8, text: "Separuhnya menguap di keputusan yang terlalu berani. Kamu tetap lebih baik dari sebelumnya, tapi cukup terbakar untuk belajar.", effects: { wealth: 12, mental: -3 } },
      ]},
    ],
  }),
  ...
  e({
    ...
    choices: [
      { id: "ambil", label: "Ambil tantangan baru.", outcomes: [
        ...
        { weight: 6, text: "Ternyata kamu pandai. Orang mulai mencari pendapatmu. Untuk pertama kali kamu merasa dilihat, bukan sekadar pengisi kursi.", effects: { wealth: 12, social: 5, mental: -3 }, flag: "manajer" },
      ]},
      { id: "tolak", label: "Tolak. Kamu suka posisi sekarang.", outcomes: [
        ...
        { weight: 8, text: "Berbulan kamu bertanya itu pengecut atau bijak. Lalu kamu lihat manajer baru pulang jam sebelas tiap malam. Pertanyaanmu terjawab sendiri.", effects: { mental: 4, happiness: 3 } },
      ]},
