...
export const AGE_POOL: LifeEvent[] = [
  e({
    ...
    choices: [
      { id: "menangis", label: "Menangis sekencang-kencangnya", outcomes: [
        ...
        { weight: 4, text: "Yang menjawab justru tawa lega seisi ruangan. Suara pertamamu disambut bahagia. Awal yang tidak semua orang dapatkan.", effects: { happiness: 4, social: 1 }, mood: "warm",
      ...
      { id: "diam", label: "Diam, mengamati lampu di langit-langit", outcomes: [
        ...
        { weight: 4, text: "Matamu mengikuti lampu, tenang, seolah sedang menimbang dunia sebelum memutuskan ikut serta.", effects: { intelligence: 3, social: -1 }, addTrait: "introvert" },
      ]},
  ...
  e({
    ...
    choices: [
      ...
      { id: "tangis", label: "Menangis, saingi hujan", outcomes: [
        { weight: 8, text: "Suaramu kecil, tapi cukup untuk membuat satu ruangan berhenti bernapas sejenak.", effects: { social: 3, happiness: 2 } },
      ]},
      { id: "hangat", label: "Diam, menempel pada yang hangat", outcomes: [
        { weight: 8, text: "Di luar dingin, di sini tidak. Kamu memilih tidak peduli pada apapun selain itu.", effects: { health: 3, mental: 2 }, mood: "warm" },
      ]},
    ],
  }),
  ...
  e({
    ...
    choices: [
      { id: "tenang", label: "Diam, ikuti sunyinya pagi", outcomes: [
        { weight: 8, text: "Kamu tidak menangis, seolah tahu pagi seharusnya dijaga tetap sunyi.", effects: { mental: 3, intelligence: 1 }, mood: "neutral",
          memory: { text: "Subuh saat kamu dilahirkan.", tag: "pagi", mood: "melancholy" } },
      ]},
      { id: "menangis", label: "Menangis", outcomes: [
        { weight: 8, text: "Suaramu adalah hal pertama yang mengisi pagi itu. Seseorang tertawa lega, di antara kantuk yang menumpuk semalaman.", effects: { social: 3, happiness: 2 }, mood: "warm" },
      ]},
      { id: "tidur", label: "Tertidur lagi", outcomes: [
  ...
  e({
    ...
    choices: [
      ...
      { id: "genggam", label: "Raih tangan yang gemetar", outcomes: [
        { weight: 8, text: "Kamu menggenggam tangan yang paling lama menatapmu. Untuknya, kamu adalah sedikit dari yang hilang, dikembalikan.", effects: { happiness: 2, social: 2 }, mood: "warm" },
      ]},
    ],
  }),
  ...
  e({
    ...
    choices: [
      { id: "melangkah", label: "Lepaskan pegangan, melangkah", outcomes: [
        { weight: 8, text: "Dua langkah, lalu jatuh tepat ke tangan itu. Seluruh ruangan bersorak untuk sesuatu yang besok akan kamu lakukan tanpa dipuji lagi.", effects: { discipline: 3, happiness: 4 }, mood: "warm",
  ...
  e({
    ...
    choices: [
      { id: "menangis", label: "Menangis, cari yang bisa dipeluk", outcomes: [
        { weight: 8, text: "Sepasang tangan datang setelah tangismu pecah. Kamu belajar bahwa takut itu lebih ringan kalau ada yang memegangmu.", effects: { happiness: 3, social: 2 }, mood: "warm" },
      ]},
      { id: "diam", label: "Diam, dengarkan sampai habis", outcomes: [
        { weight: 8, text: "Kamu menunggu suara itu reda sendiri. Belajar bahwa hal-hal yang menakutkan biasanya cuma lewat.", effects: { mental: 3, discipline: 1 } },
      ]},
    ],
  }),
  ...
  e({
    ...
    prompt: "Sesendok bubur didekatkan ke mulutmu dengan suara pesawat-pesawatan. Kamu menatap sendok itu seperti ia berniat jahat.",
    choices: [
  ...
  e({
    ...
    choices: [
      ...
      { id: "tertawa", label: "Tertawa pada cermin", outcomes: [
        { weight: 8, text: "Ia tertawa balik, persis bersamaan. Untuk satu momen, kamu yakin kamu tidak sedang sendirian. Dan keyakinan itu, anehnya, akan kamu cari lagi seumur hidup.", effects: { happiness: 3, mental: 2 }, mood: "warm" },
      ]},
    ],
  }),
  ...
  e({
    ...
    choices: [
      { id: "tampung", label: "Tampung di telapak", outcomes: [
        { weight: 8, text: "Air itu tak pernah mau tinggal. Kamu tertawa. Pelajaran paling awal, dan paling lembut, tentang hal-hal yang tidak bisa digenggam.", effects: { happiness: 3, intelligence: 2 }, mood: "warm" },
      ]},
  ...
  e({
    ...
    choices: [
      ...
      { id: "lempar", label: "Lempar ke seberang ruangan", outcomes: [
        { weight: 8, text: "Balok terlempar, kucingnya kabur. Ibu berkata 'tidak boleh'. Kata yang akan kamu dengar ribuan kali lagi.", effects: { social: 1 } },
      ]},
    ],
  }),
  ...
  e({
    ...
    choices: [
      ...
      { id: "turun", label: "Sudah waktunya turun", outcomes: [
        { weight: 8, text: "Naik ternyata mudah, turunnya tidak. Kamu menangis di puncak rak sampai ada yang datang. Pelajaran pertama, bahwa yang berani naik belum tentu tahu caranya turun.", effects: { mental: 2 }, mood: "melancholy" },
      ]},
    ],
  }),
  ...
  e({
    ...
    choices: [
      { id: "teriak", label: "Menangis sampai napas habis", outcomes: [
        { weight: 8, text: "Tidak ada yang berubah, kecuali satu hal, kamu belajar bahwa marah yang paling besar pun tidak mengubah apa-apa.", effects: { mental: -1, discipline: 1 }, mood: "melancholy" },
      ]},
  ...
  e({
    ...
    choices: [
      { id: "kenalkan", label: "Kenalkan dia ke ibu", outcomes: [
        ...
        { weight: 8, text: "Ibumu hampir tak mengangkat wajahnya dari cucian. Kamu diam-diam tetap menyisihkan satu biskuit di kursi kosong itu.", effects: { mental: 2, happiness: -1 }, mood: "melancholy",
      ...
      { id: "rahasia", label: "Simpan dia sebagai rahasia berdua", outcomes: [
        { weight: 8, text: "Dia menemanimu di sudut-sudut sepi rumah, mendengar semua yang belum bisa kamu ucapkan ke orang dewasa.", effects: { mental: 3, intelligence: 1 }, mood: "melancholy",
  ...
  e({
    ...
    prompt: "Ada tiga benda: boneka, bantal kecil, dan kain lusuh yang harus ada sebelum kamu bisa tidur. Hari ini mereka tidak ada di tempatnya.",
    choices: [
  ...
  e({
    ...
    choices: [
      { id: "terus", label: "Balas tiap jawaban dengan 'kenapa' lagi", outcomes: [
        { weight: 8, text: "Orang dewasa kehabisan jawaban. Pertama kali kamu tahu, mereka pun tidak tahu segalanya.", effects: { intelligence: 3 }, mood: "melancholy" },
      ]},
      { id: "satu", label: "Tanyakan satu yang paling mengganjal", outcomes: [
        { weight: 8, text: "Pertanyaanmu membuat ruangan diam terlalu lama. 'Nanti kamu ngerti', kata seseorang. Kalimat yang mungkin akan kamu pahami puluhan tahun kemudian.", effects: { intelligence: 2, mental: 1 }, mood: "melancholy", memory: { text: "Pertanyaan kecil yang membuat orang dewasa terdiam.", tag: "waktu", mood: "melancholy" } },
      ]},
    ],
  }),
  ...
  e({
    ...
    choices: [
      { id: "berhasil", label: "Coba sampai berhasil", outcomes: [
        ...
        { weight: 6, text: "Gagal. Malu yang pertama dalam hidupmu, yang sebenarnya tidak perlu. Ada yang membersihkan tanpa memarahimu.", effects: { mental: 1, social: 1 }, mood: "warm" },
      ]},
      { id: "tolak", label: "Belum mau, rebut kembali popokmu", outcomes: [
        { weight: 8, text: "Tidak ada yang memaksa. Lalu suatu pagi, kamu sendiri yang memutuskan sudah waktunya. Tidak semua hal perlu diburu-buru.", effects: { mental: 2, discipline: 1 }, mood: "melancholy" },
      ]},
    ],
  }),
  ...
  e({
    ...
    choices: [
      { id: "panggil", label: "Panggil ibu, minta lampu dinyalakan", outcomes: [
        { weight: 8, text: "Ibu menyalakan lampu kecil di sudut. Bayangan-bayangan menyusut jadi tumpukan baju. Kamu tidur dengan satu mata, lalu dua.", effects: { happiness: 2, mental: 2 } },
      ]},
      { id: "berani", label: "Pejamkan mata", outcomes: [
  ...
  e({
    ...
    prompt: "Sesuatu pecah di lantai. Untuk pertama kalinya kamu menemukan bahwa kamu bisa berkata 'bukan aku', dan kata-kata itu terasa seperti pintu yang istimewa.",
    choices: [
  ...
  e({
    ...
    prompt: "Kamu menemukan bahwa tubuhmu bisa berdiri di atas satu kaki, lalu melompat-lompat dengannya. Kamu butuh seseorang melihatmu.",
    choices: [
      { id: "pamer", label: "Lompat terus sampai ada yang menoleh", outcomes: [
        { weight: 8, text: "Ibu menoleh dan berkata 'hebat!'. Satu kata kecil itu membuatmu melompat sepuluh kali lagi. Kanti kamu akan lupa, betapa mudahnya dulu merasa hebat.", effects: { happiness: 3, social: 1 }, mood: "melancholy" },
        { weight: 8, text: "Kamu melompat sampai napasmu habis. 'Lihat...' katamu lebih lirih, lalu kakimu turun pelan ke lantai. Ini pertama kalinya kamu tahu rasanya memanggil dan tidak ada yang datang.", effects: { mental: -1, social: -1 }, mood: "melancholy", memory: { text: "Melompat dengan satu kaki, memanggil-manggil, tapi tak ada yang menoleh.", tag: "kesepian", mood: "melancholy" } },
      ]},
      { id: "sendiri", label: "Lompat saja walau tak ada yang lihat", outcomes: [
        { weight: 8, text: "Kamu tetap melompat, sedikit lebih pelan, lalu berhenti sendiri. Pelajaran penting hari ini, tidak semua pencapaian kecilmu harus dirayakan.", effects: { mental: 2, discipline: 1 }, mood: "melancholy", memory: { text: "Melompat dengan satu kaki, tanpa peduli ada yang menoleh.", tag: "kesepian", mood: "melancholy" } },
      ]},
    ],
  }),
  ...
  e({
    ...
    choices: [
      { id: "tunggu", label: "Tunggu sampai ada jawaban", outcomes: [
        { weight: 8, text: "'Iya, tapi masih lama sekali.' Kamu mengangguk dan kembali melihat ke luar jendela, menyimpan kalimat itu di tempat yang baru kamu pahami puluhan tahun lagi.", effects: { intelligence: 3, mental: 1 }, mood: "melancholy", memory: { text: "Pertanyaan tentang kematian, dan langit di luar jendela mobil.", tag: "langit", mood: "melancholy" } },
      ]},
      { id: "lupa", label: "Lihat sesuatu di pinggir jalan tanpa peduli jawaban", outcomes: [
        { weight: 8, text: "Sebelum jawabannya datang, perhatianmu sudah pindah ke seekor anjing di trotoar. Pertanyaan paling besar pun, di usia ini, masih kalah oleh seekor anjing.", effects: { happiness: 2, intelligence: 1 } },
      ]},
    ],
  }),
  ...
  e({
    ...
    choices: [
      { id: "istana", label: "Istana raksasa dengan helikopter", outcomes: [
        ...
        { weight: 6, text: "Gambarmu dipajang paling depan. Untuk satu hari kamu jadi anak paling terkenal di kelas.", effects: { happiness: 4, social: 4 }, addTrait: "creative" },
      ]},
      { id: "kotak", label: "Rumah kotak biasa", outcomes: [
        { weight: 8, text: "Guru menulis 'realistis' di buku catatan. Entah pujian atau bukan.", effects: { intelligence: 2 } },
      ]},
      { id: "hitam", label: "Mewarnai semuanya hitam", outcomes: [
        ...
        { weight: 4, text: "Guru menyebutmu 'seniman avant-garde kecil'. Kamu tidak tahu artinya.", addTrait: "creative", effects: { happiness: 2 } },
      ]},
  ...
  e({
    ...
    choices: [
      ...
      { id: "ulang", label: "Hapus, tulis ulang sampai benar", outcomes: [
        { weight: 8, text: "Kamu menulis ulang sampai hurufnya benar. Sejak sekecil itu, kamu tidak suka melihat yang miring dibiarkan miring.", effects: { discipline: 3 }, addTrait: "ambitious" },
      ]},
    ],
  }),
  ...
  e({
    ...
    choices: [
      ...
      { id: "tangga", label: "Hitung anak tangga rumah tiap kali naik", outcomes: [
        { weight: 8, text: "Jumlahnya selalu sama. Ada rasa aman yang aneh pada hal-hal yang tidak berubah.", effects: { mental: 2, intelligence: 1 }, mood: "melancholy", memory: { text: "Menghitung anak tangga yang jumlahnya tak pernah berubah.", tag: "waktu", mood: "melancholy" } },
      ]},
    ],
  }),
  ...
  e({
    ...
    choices: [
      { id: "minta", label: "Pulang, minta yang sama", outcomes: [
        { weight: 6, text: "Dari cara ibu tersenyum lalu mengalihkan pembicaraan, kamu menangkap sesuatu yang belum bisa kamu mengerti, tapi kamu berhenti meminta.", effects: { mental: -1, social: 1 }, mood: "melancholy", memory: { text: "Sepatu menyala milik teman, dan senyum ibu yang mengalihkan.", tag: "ibu", mood: "melancholy" } },
        { weight: 8, text: "Seminggu kemudian sepatu itu menyala di kakimu. Tapi kamu melihat ibu makan lebih sedikit dari biasanya, dan entah kenapa cahaya di tumitmu tidak seterang yang kamu bayangkan.", effects: { happiness: 1, mental: -1 }, mood: "melancholy", memory: { text: "Sepatu menyala yang kamu dapat, dan ibu yang makan lebih sedikit.", tag: "ibu", mood: "melancholy" } },
      ]},
      { id: "lupa", label: "Lupakan, perhatikan hal lain", outcomes: [
        { weight: 8, text: "Sampai rumah kamu sudah lupa soal sepatu itu, sibuk dengan kardus bekas yang jauh lebih menarik. Rasa kurang itu pergi secepat datangnya, kemewahan yang tidak akan bertahan lama.", effects: { happiness: 2, mental: 1 }, mood: "melancholy" },
      ]},
    ],
  }),
  ...
  e({
    ...
    choices: [
      { id: "ke_ibu", label: "Serahkan ke ibu, ceritakan apa adanya", outcomes: [
        { weight: 8, text: "Ibu mengusap rambutmu. 'Anak jujur', katanya. Kamu mengingat kalimat itu lebih lama dari yang seharusnya.", effects: { happiness: 4, social: 2 }, memory: { text: "Pertama kali ibumu menyebutmu 'anak jujur'.", tag: "ibu", mood: "warm" }, mood: "warm", flag: "warung_bu_tini" },
  ...
  e({
    ...
    prompt: "Anak dari rumah sebelah memanggilmu lewat pagar tiap sore. Kalian belum tahu nama lengkap masing-masing, tapi itu tidak penting selama ada bola dan matahari yang belum tenggelam.",
    choices: [
      { id: "main", label: "Lompati pagar, main sampai magrib", outcomes: [
        { weight: 8, text: "Sore itu seakan tidak pernah habis. Lalu keluarganya pindah ke kota lain. Wajahnya terekam beberapa tahun di ingatanmu sebelum akhirnya memudar.", effects: { social: 4, happiness: 4 }, mood: "warm",
      ...
      { id: "malu", label: "Balas dari balik pagar, malu-malu", outcomes: [
        { weight: 8, text: "Butuh seminggu sebelum kamu berani melompat. Lalu kalian jadi tak terpisahkan, untuk waktu yang (seperti semua waktu masa kecil) ternyata pendek.", effects: { social: 3, mental: 2 },
  ...
  e({
    ...
    choices: [
      ...
      { id: "tolak", label: "Menolak", outcomes: [
        { weight: 8, text: "Tidak ada yang terjadi. Kamu menyesal. Atau tidak? Sulit dibedakan.", effects: { discipline: 2, happiness: -1 } },
      ]},
  ...
  e({
    ...
    choices: [
      { id: "kembalikan", label: "Kembalikan besoknya", outcomes: [
        ...
        { weight: 6, text: "Dia bilang 'simpan aja, aku punya banyak.' Pensil itu jadi milikmu dengan cara yang bersih.", effects: { social: 3, happiness: 1 },
      ...
      { id: "simpan", label: "Simpan diam-diam", outcomes: [
        ...
        { weight: 4, text: "Bertahun-tahun kemudian, setiap mengingat pensil itu, ada sengatan rasa bersalah yang tak sebanding dengan harga sebatang pensil. Begitulah utang yang paling lama dibayar: yang paling kecil.", effects: { mental: -2, intelligence: 1 },
      ...
      { id: "patah", label: "Patah tanpa sengaja", outcomes: [
        ...
        { weight: 6, text: "Kamu meminta maaf dan menggantinya dengan pensilmu sendiri. Dia menerima. Pertukaran kecil yang entah kenapa kamu ingat sampai dewasa.", effects: { social: 1, mental: 1 } },
      ]},
  ...
  e({
    ...
    choices: [
      { id: "terima", label: "Tersenyum, mencoba menerima", outcomes: [
        ...
        { weight: 6, text: "Senyummu canggung dan kamu tahu itu. Tapi kamu memutuskan tidak apa-apa terlihat canggung. Penerimaan yang rapuh, tapi kamu memulainya.", effects: { mental: 3, happiness: 2 }, addTrait: "optimistic" },
      ]},
      { id: "benci", label: "Memaki diri sendiri", outcomes: [
        ...
        { weight: 6, text: "Kata-kata yang kamu lempar ke cermin, menempel di dirimu. Tidak ada yang mendengar, jadi tidak ada yang menghentikannya.", effects: { mental: -7, happiness: -4 }, flag: "self_loathing", mood: "melancholy" },
      ]},
      { id: "ubah", label: "Memutuskan 'aku akan jadi orang yang berbeda'", outcomes: [
        ...
        { weight: 6, text: "Kamu mulai dari satu hal kecil, bangun setengah jam lebih awal. Janji-janji besar kebanyakan gagal, tapi yang kecil bertahan dan diam-diam membentukmu.", effects: { discipline: 6, health: 2, mental: 2 }, addTrait: "ambitious" },
      ]},
  ...
  e({
    ...
    choices: [
      { id: "ulang", label: "Putar sampai hafal", outcomes: [
        { weight: 8, text: "Bertahun-tahun lagi, nada pertamanya saja sudah cukup menyeretmu kembali ke kamar ini, ke usia ini, ke versi dirimu yang masih percaya lagu bisa menyelamatkan orang.", effects: { happiness: 4, mental: 3 }, mood: "warm",
      ...
      { id: "bagikan", label: "Bagikan ke satu orang yang kamu percaya", outcomes: [
        { weight: 8, text: "Dia mendengarkan, lalu bilang 'biasa aja'. Ada sesuatu yang patah. Kamu belajar, ada lagu yang tetap utuh kalau hanya disimpan sendiri.", effects: { social: 2, mental: 1 }, mood: "melancholy" },
      ]},
    ],
  }),
  ...
  e({
    ...
    choices: [
      ...
      { id: "diam", label: "Diam saja, simpan momennya", outcomes: [
  ...
  e({
    ...
    choices: [
      { id: "kedokteran", label: "Kedokteran (kata orangtua)", outcomes: [
        ...
        { weight: 6, text: "Mereka bangga. Dan diam-diam, di balik rasa terpaksa, ada bagian kecil dalam dirimu yang lega punya jalan yang sudah ditentukan.", effects: { wealth: 4, discipline: 6, mental: -2 }, flag: "jurusan_kedokteran" },
      ]},
      ...
      { id: "gap_year", label: "Gap year. Cari diri sendiri.", outcomes: [
        { weight: 6, text: "Kamu menemukan dirimu. Atau hanya menunda menemukannya?", effects: { mental: 5, wealth: -5 }, addTrait: "curious", flag: "gap_year" },
  ...
  e({
    ...
    prompt: "Grup chat yang dulu ramai tiap menit sekarang sepi berhari-hari. Masing-masing pergi ke luar kota, kampus, kesibukan sendiri. Tidak ada yang bertengkar. Kalian hanya pelan-pelan berhenti.",
    choices: [
  ...
  e({
    ...
    prompt: (ctx) => karirOf(ctx.state) === "seni"
      ? "Hari pertama di agensi desain. Layar besar menyala, playlist lo-fi pelan, dan kalimat 'kita di sini seperti keluarga'."
    ...
    choices: (ctx) => {
      ...
      return [
        ...
        { id: "skeptis", label: "Tersenyum sopan, tapi tidak percaya", outcomes: [
          ...
          { weight: 6, text: seni
              ? "Kamu pulang tepat waktu dan mengerjakan desain sendiri di rumah. 'Tidak punya passion', kata mereka. Karya pribadi itu yang kelak membuka pintu yang tidak mereka punya."
              : "Kamu pulang tepat waktu, menjaga sisa hari untuk dirimu sendiri. Dianggap kurang ambisius. Tapi kamu mengukur hidup dengan penggaris yang berbeda dari mereka.", effects: { mental: 4, happiness: 3, discipline: 2 }, addTrait: "ambitious", flag: "sudah_lulus" },
        ]},
        { id: "freelance", label: seni ? "Resign minggu kedua, jadi desainer lepas" : "Resign minggu kedua, jadi freelancer", outcomes: [
          ...
          { weight: 6, text: "Tiga bulan kemudian, kamu punya 5 klien tetap. Kamu jarang tidur, tapi kamu hidup.", effects: { wealth: 8, happiness: 4 }, flag: "freelancer_sukses", extraFlags: ["sudah_lulus"] },
        ]},
        { id: "startup", label: seni ? "Pindah ke startup produk, jadi desainer pertama" : "Pindah ke startup yang menjanjikan saham", outcomes: [
          ...
          { weight: 6, text: "Startup itu exit. Kamu beli rumah cash. Tapi tidak bisa tidur.", effects: { wealth: 30, happiness: 3, mental: -3 }, achievement: "Equity Bermakna", flag: "rumah_besar", extraFlags: ["sudah_lulus"] },
        ]},
      ];
    },
  }),
  ...
  e({
    ...
    prompt: "Notifikasi masuk. Gaji pertamamu. Angka yang dulu terasa besar, sekarang terlihat hanya sebesar yang kamu butuhkan dan tidak lebih.",
    choices: (ctx) => {
      ...
      const ortuChoice = (() => {
        if (ibuHidup && ayahHidup) {
          return [{ id: "ortu", label: "Belikan sesuatu untuk orang tua", outcomes: [
            { weight: 6, text: "Mereka bilang tidak usah, tapi menyimpannya. Wajah ibumu adalah hal terbaik yang dibeli uang itu.", effects: { happiness: 5, wealth: -2, social: 2 }, mood: "warm" as const,
              memory: { text: "Hadiah pertama dari gaji pertama, dan wajah orang tuamu.", tag: "keluarga", mood: "warm" as const } },
            { weight: 8, text: "Mereka menolak keras, lalu menerimanya sambil pura-pura kesal. Malamnya kamu dengar mereka menelepon saudara, menceritakannya.", effects: { happiness: 5, wealth: -2, social: 2 }, mood: "warm" as const,
        ...
        if (ibuHidup) {
          return [{ id: "ortu", label: "Belikan sesuatu untuk Ibu", outcomes: [
            { weight: 6, text: "Ibumu bilang tidak usah, tapi menyimpannya. Wajahnya adalah hal terbaik yang dibeli uang itu.", effects: { happiness: 5, wealth: -2, social: 2 }, mood: "warm" as const,
              memory: { text: "Hadiah pertama dari gaji pertama, dan wajah ibu.", tag: "ibu", mood: "warm" as const } },
            { weight: 8, text: "Ibumu menolak keras, lalu menerimanya sambil pura-pura kesal. Malamnya kamu dengar dia menelepon saudara, menceritakannya.", effects: { happiness: 5, wealth: -2, social: 2 }, mood: "warm" as const,
        ...
        if (ayahHidup) {
          return [{ id: "ortu", label: "Belikan sesuatu untuk Ayah", outcomes: [
            { weight: 6, text: "Ayahmu bilang tidak usah, tapi menyimpannya di laci. Caranya menahan diri agar tidak tersenyum adalah hal terbaik yang dibeli uang itu.", effects: { happiness: 5, wealth: -2, social: 2 }, mood: "warm" as const,
              memory: { text: "Hadiah pertama dari gaji pertama, dan wajah ayah.", tag: "ayah", mood: "warm" as const } },
            { weight: 8, text: "Ayahmu menolak keras, lalu menerimanya sambil pura-pura kesal. Malamnya kamu dengar dia menelepon saudara, menceritakannya.", effects: { happiness: 5, wealth: -2, social: 2 }, mood: "warm" as const,
  ...
  e({
    ...
    choices: [
      { id: "klise", label: "'Saya terlalu perfeksionis.'", outcomes: [
        { weight: 8, text: "Dia mengangguk seperti belum pernah mendengarnya. Kalian sama-sama tahu ini sandiwara. Kamu dapat panggilan kedua.", effects: { social: 2, wealth: 1 } },
