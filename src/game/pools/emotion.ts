...
e({
    ...
    choices: [
      ...
      { id: "hapus_sosmed", label: "Hapus semua media sosial", outcomes: [
        ...
        { weight: 8, text: "Tiga hari pertama jempolmu masih bergerak sendiri mencari aplikasi yang sudah tidak ada. Lalu sunyi itu tidak lagi terasa kosong dan mulai terasa seperti ruang. Kamu memperhatikan hal-hal kecil lagi. Uap kopi, suara hujan, wajah orang yang sedang bicara padamu.", effects: { mental: 7, happiness: 5, social: 2 }, mood: "warm" },
      ]},
      { id: "fokus_kerja", label: "Tenggelam dalam pekerjaan", outcomes: [
        ...
        { weight: 8, text: "Sibuk itu obat bius yang efektif. Saat proyeknya selesai, setelahnya ada hening yang terasa lebih nyaring.", effects: { wealth: 6, mental: -6, happiness: -2 }, mood: "melancholy" },
      ]},
...
e({
    ...
    choices: (ctx) => [
      { id: "izin", label: "Izin sehari", outcomes: [
        ...
        { weight: 8, text: "Kamu izin sehari, tapi menghabiskannya dengan rasa bersalah. Mengecek email tiap jam, takut dianggap lemah. Tubuhmu di kasur, kepalamu di tempat kerja. Tapi setidaknya kamu mulai mengaku ada yang salah.", effects: { mental: 2, health: 1 }, flag: "burnout_1_done" },
      ]},
      { id: "paksakan", label: "Paksakan", outcomes: [
        ...
        { weight: 8, text: "Kamu paksakan, dan anehnya hari itu lewat seperti biasa, tidak ada yang runtuh. Justru itu yang menakutkan. Betapa mudah kamu menyembunyikannya. Betapa tak seorang pun akan tahu sampai semuanya terlambat.", effects: { mental: -7, health: -3 }, flag: "burnout_1_done", mood: "tragic" },
      ]},
      { id: "resign", label: "Tulis surat resign", outcomes: [
        ...
        { weight: 8, text: "Surat resign terkirim sebelum kamu sempat berpikir dua kali. Lega datang lebih dulu. Panik menyusul seminggu kemudian, saat tagihan-tagihan ternyata tidak ikut resign. Tapi untuk pertama kalinya dalam waktu lama, malam-malammu kembali jadi milikmu.", effects: { mental: 8, wealth: -9, happiness: 4 }, flag: "burnout_1_done" },
      ]},
    ],
  }),
...
e({
    ...
    choices: [
      { id: "lanjutkan", label: "Biarkan mengalir", outcomes: [
        ...
        { weight: 8, text: "Kamu biarkan tawa itu mengalir sampai habis. Orang di mobil sebelah melirik heran, dan itu malah membuatmu makin geli. Tidak semua kebahagiaan butuh sebab. Sebagian datang seperti hujan di musim yang salah.", effects: { mental: 6, happiness: 7 }, mood: "hope", memory: { text: "Tawa tanpa sebab yang kamu biarkan sampai habis.", tag: "tenang", mood: "hope" } },
      ]},
      { id: "tahan", label: "Tahan, takut dianggap aneh", outcomes: [
        ...
        { weight: 8, text: "Kamu tahan, pasang lagi wajah serius. Tapi sepanjang hari sudut bibirmu sesekali naik sendiri, mengkhianati usahamu. Ternyata sulit sekali menahan sesuatu yang murni.", effects: { mental: 2, happiness: 1 } },
      ]},
    ],
  }),
...
e({
    ...
    choices: [
      { id: "akui", label: "Akui pada diri sendiri 'ini serius!'", outcomes: [
        { weight: 8, text: "Terapi, atau jeda, atau sekadar berhenti sejenak. Kali ini kamu tidak boleh berpura-pura bisa melewatinya sendirian.", effects: { mental: 6, happiness: 3 }, flag: "burnout_2_done" },
        { weight: 8, text: "Mengakuinya keras-keras pada diri sendiri ternyata bagian tersulit. Setelah itu, langkah-langkah kecil jadi mudah: satu janji terapi, satu percakapan jujur, satu malam tidur penuh. Belum sembuh, tapi mulai.", effects: { mental: 7, happiness: 2 }, flag: "burnout_2_done" },
      ]},
      { id: "tahan_lagi", label: "Tahan saja. Dulu juga lewat.", outcomes: [
        ...
        { weight: 8, text: "Kamu tahan lagi, dan lewat lagi. Tapi kali ini kamu lihat polanya: bertahan, retak, bertahan lagi. Seperti tulang yang selalu patah di tempat sama dan makin bengkok ketika sembuh.", effects: { mental: -6, health: -6 }, flag: "burnout_2_done", mood: "tragic" },
      ]},
      { id: "cerita", label: "Ceritakan ke seseorang yang dipercaya", outcomes: [
        { weight: 8, text: "Dia tidak menyela sekalipun. Tidak memberikan solusi. Hanya hadir. Itu sudah lebih dari yang kamu butuhkan malam itu.", effects: { mental: 8, social: 4 }, flag: "burnout_2_done" },
...
e({
    ...
    choices: [
      { id: "terapi", label: "Cari psikolog besok pagi", outcomes: [
        ...
        { weight: 8, text: "Psikolog pertama tidak cocok. Yang kedua membuatmu menangis di sesi ketiga, entah kenapa. Mahal, melelahkan, kadang terasa sia-sia. Tapi pelan-pelan ada yang mencair.", effects: { mental: 8, wealth: -4, happiness: 2 } },
      ]},
      { id: "alkohol", label: "Buka botol di kulkas", outcomes: [
        ...
        { weight: 8, text: "Satu botol jadi dua. Pagi datang dengan kepala yang lebih berat dan pertanyaan yang sama, ditambah sedikit malu. Kamu berjanji ini yang terakhir. Dan kamu tidak pernah menepati janji itu.", effects: { health: -5, mental: -4 }, mood: "melancholy" },
      ]},
      ...
      { id: "scroll", label: "Scroll Instagram sampai pagi", outcomes: [
        ...
        { weight: 8, text: "Jam empat pagi, baterai 6%. Kamu sudah lupa apa yang kamu cari. Layar mati sendiri, dan dalam gelap mendadak itu wajahmu memantul di kaca, terlihat lebih tua dari yang kamu rasa.", effects: { mental: -4, health: -2, happiness: -2 }, mood: "melancholy" },
      ]},
    ],
  }),
...
e({
    ...
    choices: [
      { id: "bantuan", label: "Cari bantuan profesional, serius kali ini", outcomes: [
        { weight: 8, text: "Butuh beberapa bulan untuk mulai terasa berbeda. Tapi berbeda akhirnya datang. Pelan, tidak dramatis, tapi nyata.", effects: { mental: 12, wealth: -5, happiness: 5 }, mood: "hope", achievement: "Bertahan Lebih dari yang Kamu Kira", flag: "burnout_3_done" },
        { weight: 8, text: "Kali ini kamu benar-benar datang, dan terus datang, bahkan di minggu-minggu yang terasa percuma. Pemulihan ternyata bukan garis lurus tapi spiral. Kamu melewati titik yang sama berulang kali, hanya sedikit lebih tinggi tiap putaran.", effects: { mental: 11, wealth: -5, happiness: 4 }, flag: "burnout_3_done", mood: "hope" },
      ]},
      ...
      { id: "ubah_hidup", label: "Ubah sesuatu yang fundamental. Pekerjaan, kota, semuanya", outcomes: [
        { weight: 8, text: "Kamu pergi. Kota baru, rutinitas baru, orang-orang baru. Tubuhmu butuh waktu untuk percaya kamu tidak sedang melarikan diri.", effects: { mental: 7, wealth: -10, happiness: 4 }, flag: "burnout_3_done" },
        { weight: 8, text: "Kamu ubah satu hal besar. Kota baru tidak menyembuhkan apa-apa secara langsung. Tapi tidak adanya kenangan di setiap sudut jalan ternyata melegakan dengan caranya sendiri.", effects: { mental: 6, wealth: -8, happiness: 3 }, flag: "burnout_3_done" },
      ]},
    ],
  }),
];
